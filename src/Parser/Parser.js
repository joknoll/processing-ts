import PjsConsole from "../Helpers/PjsConsole.js";
  ...
  function parseProcessing(code) {
    ...
    function preExpressionTransform(expr) {
      ...
      s = s.replace(/"B(\d+)"(\s*(?:[\w$']|"B))/g, function (all, index, next) {
        ...
        if (
          !/^\(\s*[A-Za-z_$][\w$]*\b(?:\s*\.\s*[A-Za-z_$][\w$]*\b)*\s*(?:"C\d+"\s*)*\)$/.test(atom)
        ) {
          return all;
        }
        ...
        function (all, indexOrLength, index, atomIndex, equalsPart, rightSide) {
          if (index) {
            ...
            if (equalsPart) {
              return (
                "pixels.setPixel" +
                addAtom("(" + atom.substring(1, atom.length - 1) + "," + rightSide + ")", "B")
              );
            }
    ...
    AstForInExpression.prototype.toString = function () {
      ...
      if (init.indexOf("=") >= 0) {
        // can be without var declaration
    ...
    AstForEachExpression.prototype.toString = function () {
      ...
      var nextIterationCondition =
        iterator + ".hasNext() && ((" + variableName + " = " + iterator + ".next()) || true)";
    ...
    AstInterfaceBody.prototype.toString = function () {
      ...
      if (this.owner.interfaces) {
        ...
        for (i = 0, l = this.interfacesNames.length; i < l; ++i) {
          ...
          staticDefinitions +=
            "$p.extendInterfaceMembers(" + className + ", " + resolvedInterface + ");\n";
        }
      ...
      for (i = 0, l = this.fields.length; i < l; ++i) {
        ...
        if (field.isStatic) {
          staticDefinitions +=
            className + "." + field.definitions.join(";\n" + className + ".") + ";\n";
        }
      }
    ...
    AstClassBody.prototype.toString = function () {
      ...
      if (this.owner.base) {
        ...
        staticDefinitions +=
          "$p.extendStaticMembers(" + className + ", " + resolvedBaseClassName + ");\n";
      }
      ...
      for (i = 0, l = this.innerClasses.length; i < l; ++i) {
        ...
        if (innerClass.isStatic) {
          staticDefinitions += className + "." + innerClass.name + " = " + innerClass + ";\n";
          result +=
            selfId + "." + innerClass.name + " = " + className + "." + innerClass.name + ";\n";
        } else {
    ...
    transformMain = function () {
      ...
      return new AstRoot(
        transformStatements(statements, transformGlobalMethod, transformGlobalClass),
      );
    };
