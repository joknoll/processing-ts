...
(function () {
  ...
  var setSketches = function () {
    ...
    for (var e = 0, end = elements.length; e < end; e++) {
      ...
      if (
        canvas.getAttribute("data-processing-sources") ||
  ...
  var checkPositions = (LazyLoading.checkPositions = function () {
    ...
    Object.keys(sketches).forEach(function (s) {
      ...
      if (
        (top <= sketch.top && sketch.top <= bottom) ||
        (top <= sketch.bottom && sketch.bottom <= bottom)
      ) {
  ...
  var loadSketch = (LazyLoading.loadSketch = function (sketch) {
    if (sketch.canvas) {
      ...
      if (processingSources === null) {
        processingSources = sketch.canvas.getAttribute("data-src");
      }
      if (processingSources === null) {
        processingSources = sketch.canvas.getAttribute("datasrc");
      }
