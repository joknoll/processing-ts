 ...
 */
export default function finalizeProcessing(Processing, options) {
  // unpack options
   ...
   */
  var loadSketchFromSources = (Processing.loadSketchFromSources = function (
    canvas,
    sources,
    onComplete,
  ) {
  ...
  var init = function () {
    ...
    // sketch duplication when page content is dynamically swapped.
