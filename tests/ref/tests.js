var tests = [
  ...
  { path: "noise1d.pde", tags: ["2D", "Test Suite"], epsilonOverride: 0.1 },
  ...
  { path: "string-codepointat.pde", tags: ["2D", "Text"], epsilonOverride: 0.2 },
  { path: "string-equalsignorecase.pde", tags: ["2D", "Text"], epsilonOverride: 0.2 },
  {
    path: "text-pushpopstyle.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.35,
  } /* See ticket #1172 */,
  {
    path: "text-width.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.2,
    knownFailureTicket: "1705",
  } /* See ticket #1172 */,
  {
    path: "text-boxed-left-top.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.19,
  } /* See ticket #1172 */,
  {
    path: "text-boxed-left-center.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.21,
  } /* See ticket #1172 */,
  {
    path: "text-boxed-left-bottom.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.19,
  } /* See ticket #1172 */,
  {
    path: "text-boxed-center-top.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.18,
  } /* See ticket #1172 */,
  {
    path: "text-boxed-center-center.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.18,
  } /* See ticket #1172 */,
  {
    path: "text-boxed-center-bottom.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.18,
  } /* See ticket #1172 */,
  {
    path: "text-boxed-right-top.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.21,
  } /* See ticket #1172 */,
  {
    path: "text-boxed-right-center.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.23,
  } /* See ticket #1172 */,
  {
    path: "text-boxed-right-bottom.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.21,
  } /* See ticket #1172 */,
  {
    path: "text-boxed-vcenter.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.16,
  } /* See ticket #1172 */,
  {
    path: "text-unboxed-left-top.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.15,
  } /* See ticket #1172 */,
  { path: "text-unboxed-left-top-3D.pde", tags: ["3D", "Text"], knownFailureTicket: "750" },
  {
    path: "text-unboxed-left-center.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.11,
    knownFailureTicket: "1684",
  } /* See ticket #1172 */,
  { path: "text-unboxed-left-center-3D.pde", tags: ["3D", "Text"], knownFailureTicket: "750" },
  {
    path: "text-unboxed-left-bottom.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.15,
  } /* See ticket #1172 */,
  { path: "text-unboxed-left-bottom-3D.pde", tags: ["3D", "Text"], knownFailureTicket: "750" },
  {
    path: "text-unboxed-center-top.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.17,
  } /* See ticket #1172 */,
  { path: "text-unboxed-center-top-3D.pde", tags: ["3D", "Text"], knownFailureTicket: "750" },
  {
    path: "text-unboxed-center-center.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.12,
    knownFailureTicket: "1684",
  } /* See ticket #1172 */,
  { path: "text-unboxed-center-center-3D.pde", tags: ["3D", "Text"], knownFailureTicket: "750" },
  {
    path: "text-unboxed-center-bottom.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.17,
  } /* See ticket #1172 */,
  { path: "text-unboxed-center-bottom-3D.pde", tags: ["3D", "Text"], knownFailureTicket: "750" },
  {
    path: "text-unboxed-right-top.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.15,
  } /* See ticket #1172 */,
  { path: "text-unboxed-right-top-3D.pde", tags: ["3D", "Text"], knownFailureTicket: "750" },
  {
    path: "text-unboxed-right-center.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.13,
    knownFailureTicket: "1684",
  } /* See ticket #1172 */,
  { path: "text-unboxed-right-center-3D.pde", tags: ["3D", "Text"], knownFailureTicket: "750" },
  {
    path: "text-unboxed-right-bottom.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.15,
  } /* See ticket #1172 */,
  { path: "text-unboxed-right-bottom-3D.pde", tags: ["3D", "Text"], knownFailureTicket: "750" },
  { path: "text-defaults.pde", tags: ["2D", "Text"], epsilonOverride: 0.1 } /* See ticket #1172 */,
  { path: "text-defaults-3D.pde", tags: ["3D", "Text"], knownFailureTicket: "750" },
  {
    path: "text-ascent-descent.pde",
    tags: ["2D", "Text", "Crisp"],
    epsilonOverride: 0.09,
  } /* See ticket #1172 */,
  { path: "text-ascent-descent-3D.pde", tags: ["3D", "Text"], knownFailureTicket: "750" },
  {
    path: "text-size-recache.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.11,
  } /* See ticket #1172 */,
  ...
  {
    path: "text-font-fromfile.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.22,
  } /* See ticket #1172 */,
  {
    path: "text-font-fromfile.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.22,
  } /* repeated, to test reuse of font-face loaded fonts*/,
  {
    path: "text-valign-BOTTOM.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.12,
  } /* See ticket #1172 */,
  {
    path: "text-valign-BOTTOM-m.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.13,
  } /* See ticket #1172 */,
  {
    path: "text-valign-BASELINE.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.17,
  } /* See ticket #1172 */,
  {
    path: "text-valign-BASELINE-m.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.17,
  } /* See ticket #1172 */,
  {
    path: "text-valign-CENTER.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.14,
  } /* See ticket #1172 */,
  {
    path: "text-valign-CENTER-m.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.12,
  } /* See ticket #1172 */,
  {
    path: "text-valign-TOP.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.11,
  } /* See ticket #1172 */,
  {
    path: "text-valign-TOP-m.pde",
    tags: ["2D", "Text"],
    epsilonOverride: 0.11,
  } /* See ticket #1172 */,
  { path: "text-pfont.pde", tags: ["2D", "Text"], epsilonOverride: 0.3 } /* See ticket #1172 */,
  ...
  { path: "box-rotating.pde", tags: ["3D"], epsilonOverride: 0.1 },
  { path: "translate-rect.pde", tags: ["2D", "Crisp"] },
  { path: "arc-tangent.pde", tags: ["2D"] },
  { path: "arc_ref1.pde", tags: ["2D", "Crisp"], epsilonOverride: 0.1 },
  ...
  { path: "curveTangent.pde", tags: ["2D"], epsilonOverride: 0.1 },
  ...
  { path: "ambientLight_p5test_2.pde", tags: ["3D"], epsilonOverride: 0.1 },
  ...
  {
    path: "beginEndShape-2dnocloserectangle.pde",
    tags: ["endShape2D", "2D"],
    epsilonOverride: 0.07,
  },
  ...
  { path: "beginEndShape-2dquadstrip2.pde", tags: ["endShape2D", "2D"], epsilonOverride: 0.1 },
  ...
  { path: "beginEndShape-3dlines.pde", tags: ["endShape3D", "3D"], epsilonOverride: 0.2 },
  { path: "beginEndShape-3dnocloseline.pde", tags: ["endShape3D", "3D"], epsilonOverride: 0.15 },
  {
    path: "beginEndShape-3dnoclosetriangle.pde",
    tags: ["endShape3D", "3D"],
    epsilonOverride: 0.18,
  },
  {
    path: "beginEndShape-3dnocloserectangle.pde",
    tags: ["endShape3D", "3D"],
    epsilonOverride: 0.18,
  },
  { path: "beginEndShape-3dnofilltriangle.pde", tags: ["endShape3D", "3D"], epsilonOverride: 0.15 },
  {
    path: "beginEndShape-3dnofillrectangle.pde",
    tags: ["endShape3D", "3D"],
    knownFailureTicket: "1271",
  },
  { path: "beginEndShape-3dpoints.pde", tags: ["endShape3D", "3D"], epsilonOverride: 0.2 },
  { path: "beginEndShape-3dpolygon.pde", tags: ["endShape3D", "3D"], knownFailureTicket: "1286" },
  {
    path: "beginEndShape-3dquads.pde",
    tags: ["endShape3D", "3D"],
    epsilonOverride: 0.12,
    knownFailureTicket: "1271",
  },
  { path: "beginEndShape-3dquadstrip1.pde", tags: ["endShape3D", "3D"], epsilonOverride: 0.25 },
  { path: "beginEndShape-3dquadstrip2.pde", tags: ["endShape3D", "3D"], epsilonOverride: 0.2 },
  { path: "beginEndShape-3dtrianglefan1.pde", tags: ["endShape3D", "3D"], epsilonOverride: 0.27 },
  { path: "beginEndShape-3dtrianglefan2.pde", tags: ["endShape3D", "3D"], epsilonOverride: 0.2 },
  ...
  { path: "beginEndShape-3dtrianglestrip1.pde", tags: ["endShape3D", "3D"], epsilonOverride: 0.2 },
  { path: "beginEndShape-3dtrianglestrip2.pde", tags: ["endShape3D", "3D"], epsilonOverride: 0.2 },
